...
from .views import category_form_view, category_list, delete_category, delete_product, product_detail, product_form_view, product_list, search_view, sub_category_list
